...
global_block_types = ['placeholder_to_fix_weird_scarpet_problem', 'concrete', 'stained_glass', 'wool'];
...
help() -> (
        ...
        print('');
        print('Blocks affected: concrete, concrete powder, stained glass, wool');
